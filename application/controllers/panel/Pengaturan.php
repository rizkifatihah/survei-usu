...
class Pengaturan extends CI_Controller
{
	...
	public function identitasAplikasi($param1 = '')
	{
		...
		if ($param1 == 'doUpdate') {
			...
			$getIdentitas = $this->GeneralModel->get_general('survei_identitas');
			...
			if ($this->GeneralModel->update_general('survei_identitas', 'id_profile', 1, $identitasAplikasi) == true) {
			...
			$data['subtitle'] = 'Application';
			$data['content'] = 'panel/pengaturan/identitas/update';
			$data['identitas'] = $this->GeneralModel->get_by_id_general('survei_identitas','id_profile',1);
