	...
	public function edit($param1=''){
		if ($param1=='doEdit') {
				...
				if (! $this->upload->do_upload('foto_pengguna')) {
						...
						$pengguna = $this->GeneralModel->get_by_id_general('survei_pengguna', 'id_pengguna', $this->session->userdata('id_pengguna'));
				...
				if ($this->GeneralModel->update_general('survei_pengguna','id_pengguna',$this->session->userdata('id_pengguna'),$dataPengguna)==true) {
