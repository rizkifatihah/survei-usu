		...
		<div class="row">
			<div class="form-box col-md-8 col-sm-10 col-xs-12">
				...
				<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 form-login" align="center">
					...
					<h2 align="center" class="text-grey text-light">Login<br><?php echo $appsProfile->apps_name; ?></h2><br>
					<form method="post" action="<?php echo base_url('auth/login/do_login'); ?>">
						<?php echo $this->session->flashdata('notif'); ?>
						<div class="form-group">
							<i class="fa fa-user icon-input"></i> <input type="text" name="username" id="userid" class="form-control input-line" placeholder="Username" required="true" />
						</div>
						<div class="form-group">
							<div class="password">
								<i style="margin-left:-20px;" class="fa fa-key icon-input"></i>
								<input type="password" id="password" name="password" class="form-control input-line" placeholder="Password" required="true" />
								<span id="iconshow" name="iconshow" onClick="showPass()" class=" showbtn fa fa-eye-slash"></span>
							</div>
						</div>
						<br />
						<div class="form-group" align="center">
							<button type="submit" class="btn btn-flat btn-primary ">Login to application <i class="fa fa-angle-right"></i></button>
							<br><br>
							<hr>
							<br>
